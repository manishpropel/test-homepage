...
import { DEMO_APP, DZAP_HASHTAG, GET_STARTED_STEPS, LAUNCH_APP, MAIN_APP_DESCRIPTION, MAIN_APP_TITLE, OPACITY_RANGE, STATS } from '../constants/AppConstants';
    ...
    <div className='w-full mt-36 flex flex-col justify-center items-center text-white'>
      ...
      <div className='flex items-center justify-center gap-x-5'>
        ...
        <button type='button' className='flex h-60px justify-center rounded-md items-center gap-x-4 px-5 border border-green300'>
          <p className='text-sm font-bold text-green300 uppercase'>{DEMO_APP}</p>
        </button>
      </div>
      <Stats />
    </div>
