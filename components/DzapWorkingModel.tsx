  ...
  return (
    <div className='m-auto text-center'>
      <div ref={parallaxOpaqueWhatWeDo.ref}>
        <p className='text-gray400 font-black text-xl md:text-2xl'> {WORKING_MODAL.title} </p>
        <h1 className='text-2xl md:text-3xl max-w-526px m-auto font-bold text-white'> {WORKING_MODAL.textWhite} <span style={workingModalStyle}> {WORKING_MODAL.textGradient} </span></h1>
      </div>
      <Parallax opacity={OPACITY_RANGE}>
        <div className='md:mt-20 md:mb-28 my-36 rotate-90 md:rotate-0'>
